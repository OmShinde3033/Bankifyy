...
if (isset($_POST['withdraw'])) {
  ...
  if ($withdraw_result === true) {
      $withdraw_message = "Withdrawal successful.";
  } else {
      $withdraw_message = "Withdrawal failed. Insufficient balance.";
  }
}
    ...
    <header class="header sticky">
      ...
      <nav class="main-nav">
        <ul class="main-nav-list">
          ...
          <li>
            <a class="main-nav-link1 nav-cta" href="http://127.0.0.1:5000/execute_script">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
  ...
  <div class="modal-content">
    ...
    <form id="depositForm" action="" method="post">
      <div class="form-group">
        ...
        <input type="text" id="beneficiary_account" name="beneficiary_account" placeholder="BBXXXXXXXX"  required>
      </div>
      <div class="form-group">
  ...
  <div class="btn2">
    <a class="card-btn nav-cta1" href="#" id="withdrawBtn">Withdraw Money</a>
        ...
        <div class="deposit">
          ...
          <div class="btn2">
            <a class="card-btn nav-cta1" href="#">View History</a>
          </div>
        </div>
      </div>
      <!-- Profile -->
